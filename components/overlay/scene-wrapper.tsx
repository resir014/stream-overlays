...
export const SceneWrapper: React.FC<SceneWrapperProps> = ({ children, showClock }) => {
  return (
    <div className="grid grid-rows-scene-wrapper grid-cols-1 flex-1 w-full min-w-[450px] relative bg-chungking-black bg-opacity-50">
      <div className="flex flex-col px-12 pt-6">{children}</div>
